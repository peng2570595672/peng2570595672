...
App({
	...
	globalData: {
		...
		cictBankObj: {	// 中信对象
			...
			cictBankNmGoldCard: IS_TEST ? '1160975248860913664' : '',	// 中信银行蒙通卡套餐的金卡套餐ID 分别是测试环境下和正式环境下
			cictBankNmPlatinumCard: IS_TEST ? '1160975461608595456' : '',	// 中信银行蒙通卡套餐的白金卡套餐ID 分别是测试环境下和正式环境下
			citicBankshopProductIds: IS_TEST ? ['1108398050782486528','1108397635760300032','1160975248860913664','1160975461608595456','1160975461608595456'] : ['1109116737144102912','1109116407530528768','','','1129091866749968384']	// 套餐ID集合
		},
		alertNotice: {
			imgAlert: 0,
			textAlert: 0
