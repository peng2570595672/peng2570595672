...
Page({
	data: {
		...
		listOfPackages: [
			...
			scalpCheck: 1,
			serviceFeeAmount: 0,
			serviceFeeAmountSendRule: 1,
			serviceFeePackageId: '0',
			serviceFeePackageSendRule: 1,
			serviceFeeSendType: 0,
			serviceFeeType: 0,
			serviceSysPlanId: 0,
			shopId: '1224307861486575616',
			shopProductId: '1224310125655760896',
			shopProductStatus: 1,
			sortOrder: 0,
			spBankCode: '',
			spClientPort: '',
