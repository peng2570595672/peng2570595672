...
Page({
	data: {
		listOne: [
			{title1: 'ETC设备',title2: '包含OUB设备一台及卡片一张',text: '当您的ETC激活以后，即可全国通行，过站免排队，全国高速通行95折，如部分省份高速或路段还有其他优惠可叠加同享。'},
			{title1: '整机保修',title2: '合约期内只换不修',text: '合约期内只换不修'},
			{title1: '在线客服',title2: '全天候服务支持',text: '在线客服：尊敬的车主，我们为您7*24H在线专人客服，如有疑问点击这里立即咨询'},
			{title1: '权益商城',title2: '全天候服务支持',text: '我们准备了涵盖出行、生活、影视听娱乐、免税商品等多项权益，任供ETC车主用户消费及使用'}
		],
