...
Page({
	data: {
		...
		arrearsInstructionsList: [
			{ title: '1.为什么产生服务费？',content: '用户车辆产生高速通行费且扣费失败时，我司将垫付该笔通行费至发卡方高速集团以保证用户的能够正常通行。若该笔通行费在首次扣费失败的次日0点起15日内未补扣成功或用户没有主动补缴这笔通行费，第16日起我司会额外向用户收取服务费。' },
			{title: '2.服务费收取标准是什么？',content: '服务费每日按应付通行费的万分之四进行计算，累计服务费每年不超过通行费的18%。'},
			{title: '3.多久开始计算服务费？',content: '通行费扣费失败的第16个自然日的0点起开始计算。'},
			{title: '4.举例说明：',content: '车辆1月1日通行高速时产生一条为50元通行金额的账单并发起扣款，若扣款失败，24小时期间我司主动对用户的通行扣费账户发起此条欠费账单补扣或用户主动补缴，期间未补扣或未补缴成功，则从1月17日（第16个自然日）0点起按日计算服务费。'}
		]
	},
	onLoad (options) {
		this.setData({
