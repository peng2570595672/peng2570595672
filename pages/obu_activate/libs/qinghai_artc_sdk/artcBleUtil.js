...
const start80Time = 240
const wait80ResponseTime = 1000
const codeEnum = {
  successCode: 0,
  failureCode: 1,
  stopScanFailure: 2,
...
var start80Timer//等待发送a2指令
var wait80ResponseTimer//等待a2回复
var frame = ""//一帧数据
...
function connectBleDevice(deviceId, callback) {
  ...
  if (typeof wait80ResponseTimer != undefined) clearTimeout(wait80ResponseTimer)
 ...
 */
function initDevice() {
  sendDataToDevice(dataUtil.make80SendData(), (code, data, msg) => {
    if (typeof connectTimer != undefined) clearTimeout(connectTimer)
    if (typeof wait80ResponseTimer != undefined) clearTimeout(wait80ResponseTimer)
