...
Page({
	...
	onLoad (options) {
		...
		if (options.type === 'violation_enquiry') {
			...
			url = 'https://xiaochengxu.soboten.com/chat/h5/v6/index.html?sysnum=7d11a91e6a20414da4186004d03807fd&channelid=5&useWxjs=true'
			// url = `https://wpa1.qq.com/jjrmum8i?_type=wpa&qidian=true`;
		} else if (options.type === 'refund_customer_service') {
			url = 'https://tuikuan.soboten.com/chat/h5/v6/index.html?sysnum=7d11a91e6a20414da4186004d03807fd&channelid=4&useWxjs=true'
