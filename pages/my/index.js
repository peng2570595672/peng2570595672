...
Page({
	...
	swiperChange (e) {
		...
		console.log('轮播图自动轮播时触发', current);
		if (this.data.carouselList[current].jumpUrl === '平安测额' || this.data.carouselList[current].jumpUrl === '/pages/personal_center/quotaLandingPage/quotaLandingPage') {
			this.useBriedPoint();
		}
	},
	useBriedPoint () {
