...
Page({
	...
	availableCheck () {
		...
		if (this.data.orderInfo && this.data.orderInfo.isOwner === 1 && this.data.orderInfo.isVehicle === 1 && ((this.data.orderInfo.obuCardType === 1) || (this.data.orderInfo.isHeadstock === 1 && this.data.orderInfo.obuCardType !== 1))) {
			this.setData({
				available: true
			});
		}
