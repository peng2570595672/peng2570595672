 ...
 * 开始搜寻附近的蓝牙外围设备
 */
const startBluetoothDevicesDiscovery=function(callback,fun){
  console.log("开始寻附近蓝牙")
  ...
  console.log("===================开始监听====================")
   wx.onBluetoothDeviceFound((res)=>{
          ...
          let result={
                ...
                isShow: foundDevices.length > 0 ? true : false,
                name1:name1
              }
 ...
 */
const stopBluetoothDevicesDiscovery=function(){
  wx.stopBluetoothDevicesDiscovery({
    success (res) {
      console.log(res)
    }
